...
import com.error_found.kotdroid.phonebook.utils.MarshMallowPermissions;
    ...
    private void startCameraIntent() {
        ...
        try {
            ...
            Uri outputUri = FileProvider
                    .getUriForFile(getActivity(), com.error_found.kotdroid.phonebook.BuildConfig.APPLICATION_ID + ".provider", file);
